...
public class PartnersAddTextStory{
	...
	@Test
	public void partnersAddTextStory() throws InterruptedException
	{
		    Thread.sleep(2000);
		    ...
		    driver.findElement(By.xpath("//li[contains(text(),'Text Story')]")).click();
		    System.out.println("clicked on Text Story");
		    Thread.sleep(2000);
		    
		    driver.findElement(By.xpath("//button[contains(text(),'Post Story')]")).click();
		    System.out.println("click on Post button--> 'Check that Paragraph is a mandatory field'");
		    Thread.sleep(2000);

		    driver.findElement(By.xpath("//p[@data-placeholder='Story Text']")).sendKeys("Hellooo, bbbbbbb");
		    System.out.println("click on Story text value");
		    Thread.sleep(2000);
