...
public class PartnersAddVideoStory{
	...
	@Test
	public void partnersAddVideoStory() throws InterruptedException
	{
		    Thread.sleep(2000);
		    ...
		    driver.findElement(By.xpath("//li[contains(text(),'Video Story')]")).click();
		    System.out.println("clicked on Video Story");
		    Thread.sleep(2000);
		    
		    driver.findElement(By.xpath("//button[contains(text(),'Post Story')]")).click();
		    System.out.println("click on Post button--> 'Check that upload video is a mandatory field'");
		    Thread.sleep(2000);

		    driver.findElement(By.xpath("//span[@class='btn btn-secondary btn-file mt-3']//input[@type='file']")).sendKeys("C:\\Users\\Vedant\\Desktop\\test video.mp4");
