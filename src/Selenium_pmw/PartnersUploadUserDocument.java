...
public class PartnersUploadUserDocument{
	...
	@Test
	public void partnersUploadUserDocument() throws InterruptedException
	{
		    Thread.sleep(2000);
		    ...
		    driver.findElement(By.xpath("//button[contains(text(),'Upload User Documents')]")).click();
		    System.out.println("Clicked on 'Upload User Documents'");
		    Thread.sleep(3000);
		    ...
		    driver.findElement(By.xpath("//input[contains(@type,'file')]")).sendKeys("C:\\Users\\Vedant\\Desktop\\uploadDocument.xlsx");
