...
public class PartnersUserWallet{
	...
	@Test
	public void partnersUserWallet() throws InterruptedException
	{
		    Thread.sleep(2000);
		    ...
		    driver.findElement(By.xpath("//body/div[@id='root']/div[contains(@class,'bg-light no-gutters row')]/div[contains(@class,'py-2 col")).click();
		    System.out.println("click on wallet button and file will be downloaded");
		    Thread.sleep(4000);
